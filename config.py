...
LANGUAGE_CONFIGS = {
    "python": LanguageConfig(
        ...
        min_stars=100,
        target_repos=1000,
        test_path_patterns=["test/", "tests/", "test_", "conftest"],
        test_file_suffixes=["test_.py", "_test.py"],
    ),
    "java": LanguageConfig(
        name="Java",
        ...
        test_file_suffixes=["Test.java", "Tests.java", "IT.java"],
    ),
    "javascript": LanguageConfig(
        ...
        test_file_suffixes=[".test.js", ".spec.js", "test.js"],
    ),
    "typescript": LanguageConfig(
        ...
        target_repos=600,
        test_path_patterns=["__tests__/", "test/", "tests/", "spec/"],
        test_file_suffixes=[".test.ts", ".spec.ts", "test.ts"],
    ),
    "go": LanguageConfig(
        name="Go",
        github_language="Go",
