...
"""
            ...
            assert actual_scope == expected_normalized or fixture.scope == expected_scope
...
"""
        ...
        assert unittest_fixture.scope == pytest_fixture.scope or \
               unittest_fixture.scope in ('per_test', 'per_function') and \
               pytest_fixture.scope in ('per_test', 'per_function')
...
"""
        ...
        unittest_fixture = assert_fixture_detected(unittest_code, 'python', 'setUpClass')
        pytest_fixture = assert_fixture_detected(pytest_code, 'python', 'my_fixture')
        
        # Both should map to per_class
        assert unittest_fixture.scope == pytest_fixture.scope or \
               (unittest_fixture.scope == 'per_class' and pytest_fixture.scope == 'per_class')
